...
pub const TEP_PRINT_INFO: &[u8; 5usize] = b"INFO\0";
pub const TEP_PRINT_INFO_RAW: &[u8; 9usize] = b"INFO_RAW\0";
pub const TEP_PRINT_COMM: &[u8; 5usize] = b"COMM\0";
pub const TEP_PRINT_LATENCY: &[u8; 8usize] = b"LATENCY\0";
pub const TEP_PRINT_NAME: &[u8; 5usize] = b"NAME\0";
...
pub const TRACEFS_HIST_TIMESTAMP: &[u8; 17usize] = b"common_timestamp\0";
pub const TRACEFS_HIST_TIMESTAMP_USECS: &[u8; 23usize] = b"common_timestamp.usecs\0";
pub const TRACEFS_HIST_CPU: &[u8; 4usize] = b"cpu\0";
pub const TRACEFS_HIST_COUNTER: &[u8; 12usize] = b"__COUNTER__\0";
pub const TRACEFS_HIST_HITCOUNT: &[u8; 9usize] = b"hitcount\0";
pub const TRACEFS_TIMESTAMP: &[u8; 17usize] = b"common_timestamp\0";
pub const TRACEFS_TIMESTAMP_USECS: &[u8; 23usize] = b"common_timestamp.usecs\0";
...
pub const tep_print_arg_type_TEP_PRINT_CPUMASK: tep_print_arg_type = 16;
...
pub const TEP_EVENT_FL_ISFTRACE: _bindgen_ty_1 = 1;
pub const TEP_EVENT_FL_ISPRINT: _bindgen_ty_1 = 2;
pub const TEP_EVENT_FL_ISBPRINT: _bindgen_ty_1 = 4;
pub const TEP_EVENT_FL_ISFUNCENT: _bindgen_ty_1 = 16;
pub const TEP_EVENT_FL_ISFUNCRET: _bindgen_ty_1 = 32;
pub const TEP_EVENT_FL_NOHANDLE: _bindgen_ty_1 = 64;
pub const TEP_EVENT_FL_PRINTRAW: _bindgen_ty_1 = 128;
pub const TEP_EVENT_FL_FAILED: _bindgen_ty_1 = 2147483648;
...
extern "C" {
    pub fn tep_find_function_info(
        tep: *mut tep_handle,
        addr: ::std::os::raw::c_ulonglong,
        name: *mut *const ::std::os::raw::c_char,
        start: *mut ::std::os::raw::c_ulonglong,
...
extern "C" {
    pub fn tep_kbuffer(tep: *mut tep_handle) -> *mut kbuffer;
}
extern "C" {
...
extern "C" {
    pub fn tep_plugin_kvm_get_func(
        event: *mut tep_event,
        record: *mut tep_record,
        paddr: *mut ::std::os::raw::c_ulonglong,
    ) -> *const ::std::os::raw::c_char;
}
extern "C" {
    pub fn tep_plugin_kvm_put_func(func: *const ::std::os::raw::c_char);
}
extern "C" {
...
extern "C" {
    pub fn tracefs_set_tracing_dir(
        tracing_dir: *mut ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn tracefs_tracing_dir_is_mounted(
        mount: bool,
...
extern "C" {
    pub fn tracefs_instance_get_buffer_size(
        instance: *mut tracefs_instance,
        cpu: ::std::os::raw::c_int,
    ) -> isize;
}
extern "C" {
    pub fn tracefs_instance_set_buffer_size(
        instance: *mut tracefs_instance,
        size: usize,
        cpu: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
...
pub const tracefs_enable_state_TRACEFS_ERROR: tracefs_enable_state = -1;
pub const tracefs_enable_state_TRACEFS_ALL_DISABLED: tracefs_enable_state = 0;
pub const tracefs_enable_state_TRACEFS_ALL_ENABLED: tracefs_enable_state = 1;
pub const tracefs_enable_state_TRACEFS_SOME_ENABLED: tracefs_enable_state = 2;
pub type tracefs_enable_state = ::std::os::raw::c_int;
extern "C" {
...
extern "C" {
    pub fn tracefs_event_is_enabled(
        instance: *mut tracefs_instance,
        system: *const ::std::os::raw::c_char,
        event: *const ::std::os::raw::c_char,
    ) -> tracefs_enable_state;
}
extern "C" {
...
extern "C" {
    pub fn tracefs_tracer_available(
        tracing_dir: *const ::std::os::raw::c_char,
        tracer: *const ::std::os::raw::c_char,
    ) -> bool;
}
extern "C" {
...
extern "C" {
    pub fn tracefs_follow_missed_events(
        instance: *mut tracefs_instance,
        callback: ::std::option::Option<
            unsafe extern "C" fn(
                arg1: *mut tep_event,
...
pub const TRACEFS_FL_RESET: _bindgen_ty_2 = 1;
pub const TRACEFS_FL_CONTINUE: _bindgen_ty_2 = 2;
pub const TRACEFS_FL_FUTURE: _bindgen_ty_2 = 4;
...
pub const tracefs_hist_key_type_TRACEFS_HIST_KEY_BUCKETS: tracefs_hist_key_type = 8;
pub const tracefs_hist_key_type_TRACEFS_HIST_KEY_MAX: tracefs_hist_key_type = 9;
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct tracefs_hist_axis_cnt {
    pub key: *const ::std::os::raw::c_char,
    pub type_: tracefs_hist_key_type,
    pub cnt: ::std::os::raw::c_int,
}
impl Default for tracefs_hist_axis_cnt {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
extern "C" {
    pub fn tracefs_hist_alloc_nd_cnt(
        tep: *mut tep_handle,
        system: *const ::std::os::raw::c_char,
        event_name: *const ::std::os::raw::c_char,
        axes: *mut tracefs_hist_axis_cnt,
    ) -> *mut tracefs_hist;
}
extern "C" {
...
extern "C" {
    pub fn tracefs_hist_add_key_cnt(
        hist: *mut tracefs_hist,
        key: *const ::std::os::raw::c_char,
        type_: tracefs_hist_key_type,
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct tracefs_cpu {
    _unused: [u8; 0],
}
extern "C" {
    pub fn tracefs_cpu_alloc_fd(
        fd: ::std::os::raw::c_int,
        subbuf_size: ::std::os::raw::c_int,
        nonblock: bool,
    ) -> *mut tracefs_cpu;
}
extern "C" {
    pub fn tracefs_cpu_open(
        instance: *mut tracefs_instance,
        cpu: ::std::os::raw::c_int,
        nonblock: bool,
    ) -> *mut tracefs_cpu;
...
extern "C" {
    pub fn tracefs_cpu_close(tcpu: *mut tracefs_cpu);
}
extern "C" {
    pub fn tracefs_cpu_free_fd(tcpu: *mut tracefs_cpu);
}
extern "C" {
    pub fn tracefs_cpu_read_size(tcpu: *mut tracefs_cpu) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn tracefs_cpu_read(
        tcpu: *mut tracefs_cpu,
        buffer: *mut ::std::os::raw::c_void,
        nonblock: bool,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn tracefs_cpu_buffered_read(
        tcpu: *mut tracefs_cpu,
        buffer: *mut ::std::os::raw::c_void,
        nonblock: bool,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    pub fn tracefs_cpu_stop(tcpu: *mut tracefs_cpu) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn tracefs_cpu_flush(
        tcpu: *mut tracefs_cpu,
        buffer: *mut ::std::os::raw::c_void,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn tracefs_cpu_flush_write(
        tcpu: *mut tracefs_cpu,
        wfd: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn tracefs_cpu_pipe(
        tcpu: *mut tracefs_cpu,
        wfd: ::std::os::raw::c_int,
        nonblock: bool,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    pub fn tracecmd_follow_missed_events(
        handle: *mut tracecmd_input,
        callback: ::std::option::Option<
            unsafe extern "C" fn(
                handle: *mut tracecmd_input,
